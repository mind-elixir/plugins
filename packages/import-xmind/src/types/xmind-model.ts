// https://github.com/xmindltd/xmind-sdk-js/blob/master/src/common/model.ts
/* Basic type alias */
...
// @ts-ignore
type Model = Sheet | SheetSetting | Relationship | Legend | Theme | Style | Topic | Image | Numbering | Notes | Extension
